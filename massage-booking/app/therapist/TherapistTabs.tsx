...
export function TherapistTabs() {
  ...
  return (
    <nav className="grid w-full grid-cols-3 gap-1.5 sm:gap-2">
      {TABS.map((tab) => {
        ...
        return (
          <Link
            key={tab.href}
            href={tab.href}
            className={`rounded-lg px-1.5 py-2 text-center text-[11px] leading-tight transition sm:px-3.5 sm:text-sm ${
              active
